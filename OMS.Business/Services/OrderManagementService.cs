        ...
        public ServiceResult AcceptOfferAsEditor(int editorId, int orderDetailId, decimal? price) {
            ...
            try {
                var orderDetail =
                    _model.OrderDetails.Include(a => a.Order)
                        .Include(a => a.TranslationOperation)
                        .FirstOrDefault(a => a.TranslationOperation.TranslatorId == editorId && a.Id == orderDetailId);
        ...
        public ServiceResult AcceptOfferAsProofReader(int proofReaderId, int orderDetailId, decimal? price) {
            ...
            try {
                var orderDetail =
                    _model.OrderDetails.Include(a => a.Order)
                        .Include(a => a.TranslationOperation)
                        .FirstOrDefault(a => a.TranslationOperation.TranslatorId == proofReaderId && a.Id == orderDetailId);
